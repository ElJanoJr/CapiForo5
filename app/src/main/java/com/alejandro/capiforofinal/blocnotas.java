...
public class blocnotas extends AppCompatActivity {
    ...
    public void insertar()
    {
        try
        {
            ...
            SQLiteDatabase db = openOrCreateDatabase("basedatos", Context.MODE_PRIVATE,null);
            db.execSQL("CREATE TABLE IF NOT EXISTS Notas(id INTEGER PRIMARY KEY AUTOINCREMENT,nombre VARCHAR,apellido VARCHAR,edad VARCHAR)");
